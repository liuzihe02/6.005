...
public class FilterTest {
    ...
    // the appropriate sections are tweets.size() 0,1,2 and length 0 or more than 0
    ...
    public void testContainingMultipleWordsDifferentCase() {
        List<Tweet> containing = Filter.containing(Arrays.asList(tweet1, tweet2, tweet3, tweet4, tweet5),
                Arrays.asList("Sup", "MESSAGE"));
